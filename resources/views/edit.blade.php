            ...
            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <select name="state" class="form-select" id="">
                        ...
                        <option value="PENDING"     @selected("PENDING"     == $task->state) >Pendiente</option>
                        <option value="IN_PROGRESS" @selected("IN_PROGRESS" == $task->state) >En progreso</option>
                        <option value="COMPLETE"    @selected("COMPLETE"    == $task->state) >Completada</option>
                    </select>
                </div>
            </div>
